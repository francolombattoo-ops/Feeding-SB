...
export interface Dieta {
  ...
  capacidad_maxima_mh: number | null; // kg MH — límite recomendado del mixer para esta dieta
  activo: boolean;
  created_at: string;
  updated_at: string;
}
...
// ============================================================
// V2 — Historial inmutable, ajustes manuales, mixer
// ============================================================

/** Registro "foto del día" — se crea únicamente al confirmar una entrega. Inmutable. */
...
export interface EntregaDiariaConCorral extends EntregaDiaria {
  corral: Pick<Corral, 'id' | 'nombre'>;
}

export type AjusteOrigen = 'LECTURA_SOBRA' | 'LECTURA_FALTA' | 'MANUAL';
export type AjusteDireccion = 'AUMENTO' | 'REDUCCION';
...
// ============================================================
// V3 — Autenticación y roles
/** Resumen liviano de un día anterior, para mostrar en la tarjeta de corral sin ir al historial completo. */
export interface ResumenDiaAnterior {
  fecha: string;
  dietaNombre: string | null;
  consumoObjetivoPct: number | null;
