...
export interface IndicadoresDieta {
  ...
  relacionPbEm: number;           // gramos de PB por Mcal de EM: (PB% × 10) / EM
...
export function calcularIndicadoresDieta(
  ...
  // relación PB/EM en unidades reales de nutrición: gramos de proteína bruta
  // por Mcal de energía metabolizable. PB está en % sobre MS (ej 14.6 = 14.6%),
  // así que %×10 = gramos de PB por kg de MS; dividido por Mcal/kg MS da g PB/Mcal.
  const relacionPbEm = emPonderada > 0 ? (pbPonderada * 10) / emPonderada : 0;
