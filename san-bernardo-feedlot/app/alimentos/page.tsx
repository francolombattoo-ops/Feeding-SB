      ...
      <div className="max-w-4xl mx-auto px-4 md:px-8 py-6 md:py-10">
        <Card className="py-14 text-center">
          <CardContent>
            ...
            <p className="font-display font-semibold text-earth-950 mb-1">Acceso restringido</p>
            <p className="text-earth-700/60 text-sm">Este módulo es exclusivo del Administrador.</p>
          </CardContent>
        </Card>
      </div>
    );
