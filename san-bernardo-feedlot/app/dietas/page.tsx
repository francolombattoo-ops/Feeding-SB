...
export default function DietasPage() {
  ...
  async function handleGuardar(data: { nombre: string; ingredientes: Array<{ alimento_id: string; porcentaje_ms: number }> }) {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 md:px-8 py-6 md:py-10">
      <header className="flex items-center justify-between mb-6">
        ...
        <Button onClick={abrirNueva}>+ Nueva dieta</Button>
      </header>
              ...
              <Card key={d.id} className="hover:shadow-card-lg transition-shadow">
                <CardContent className="p-5">
                  ...
                  <div className="grid grid-cols-4 gap-2 pt-3 border-t border-earth-700/10">
                    ...
                    <MiniIndicador label="PB/EM" valor={formatDecimal(indicadores.relacionPbEm, 2)} />
                  </div>
                </CardContent>
              </Card>
            );
